...
#        print("Yes buddy")
 #       print(np.reshape(output, (dim1, dim2, dim3, dim4)))
...
class TrtYOLOv3(object):
    ...
    def _load_engine(self):
        TRTbin = '/home/omais/IISWC/tensorrt_demos/yolov3_onnx/yolov3-tiny-416.trt'
    ...
    def __init__(self, model, input_shape=(416, 416)):
        ...
        h, w = input_shape
        if 'tiny' in model:
            self.output_shapes = [(1, 39, h // 32, w // 32),(1, 39, h // 16, w // 16)]
        else:
            self.output_shapes = [(1, 39, h // 32, w // 32),
                                  (1, 39, h // 16, w // 16),
                                  (1, 39, h //  8, w //  8)]
        #print("The output shapes is this")
    ...
    #    print(len(trt_outputs))
     #   print(trt_outputs)
       # for output,shape in zip(trt_outputs, self.input_shape):
        #    print (shape)
