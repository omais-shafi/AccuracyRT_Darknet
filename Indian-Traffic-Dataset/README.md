...
2. Give the path to the test image dataset(<i>large_data</i> folder of the google drive link) along with the annotations in json format(<i>traffic.json</i> file attached in the folder).<br>
